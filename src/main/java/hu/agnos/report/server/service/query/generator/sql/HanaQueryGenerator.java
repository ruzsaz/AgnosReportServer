 ...
 * @author parisek
 */
public class HanaQueryGenerator implements AbstractQueryGenerator{
    
  
     private final String CUBENAMEOFFSET = "_SYS_BIC\".\"PULZUS.MODELS.PI/";
...
//            System.out.println("debug: " + indicator.getJSONFull());
        ...
        if (sql_select.length() > 0) {
            ...
            sql.append("\nFROM \"").append(CUBENAMEOFFSET).append(cubeName).append("\"");
